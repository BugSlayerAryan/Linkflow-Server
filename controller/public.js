...
<video
  ...
  src={selectedPreview}
  poster={videoInfo?.thumb ? getProxyImageUrl(videoInfo.thumb) : undefined}
  controls
  playsInline
  preload="metadata"
  autoPlay={false}
  ...
  onError={(event) => {
    console.error("Preview video failed:", event.currentTarget.error);
    toast.error("Preview failed to play. Try downloading or another quality.");
  }}
